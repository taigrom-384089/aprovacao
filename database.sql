...
CREATE TABLE [dbo].[TB_ITEM_NOTA](
	[ID_ITEM_NOTA] [int] IDENTITY(1,1) NOT NULL,
	[ID_NOTA_COMPRA] [int] NOT NULL,
	[ID_NOTA_COMPRA_AGREGADA] [int] NOT NULL,
	[DESCRICAO] [NVARCHAR](20) NOT NULL,
	[QUANTIDADE] [numeric](18, 2) NOT NULL,
)

INSERT INTO TB_ITEM_NOTA VALUES (1, 2, 'Lapis de cor', 2)
INSERT INTO TB_ITEM_NOTA VALUES (1, 3, 'Caderno', 3)
INSERT INTO TB_ITEM_NOTA VALUES (1, 4, 'Mochila', 4)

INSERT INTO TB_ITEM_NOTA VALUES (2, 3, 'Lapis de cor', 1)
INSERT INTO TB_ITEM_NOTA VALUES (2, 4, 'Caderno', 1)
INSERT INTO TB_ITEM_NOTA VALUES (2, 5, 'Mochila', 1)
INSERT INTO TB_ITEM_NOTA VALUES (2, 6, 'Uniforme', 4)
